...
- Do NOT touch `unknownDirectoryCountBackstop` (5,000); it deliberately has the same value as `LiveRefreshPolicy`'s storm threshold, and independent boundary tests pin both to 5,000.
