# batched-subtree-splice Specification

## Purpose
Batched warm-patch splicing: all changed roots staged concurrently and installed in one transactional compaction, with admission by estimated changed-item fraction.
## Requirements
