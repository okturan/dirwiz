# menu-bar-presence Specification

## Purpose
The resident menu bar surface over existing scan, monitor, and checkpoint state: item and panel, accessory-mode residency, login item, notification policy, and the automation surfaces.
## Requirements
