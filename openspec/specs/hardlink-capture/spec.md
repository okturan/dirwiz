# hardlink-capture Specification

## Purpose
Capture link-count evidence during scans and keep hardlink groups available automatically without compromising cache or fast-path correctness.
## Requirements
