# scan-supervision-under-load Specification

## Purpose
Require scan and warm-patch supervision to remain coherent under contention and make intermittent failures diagnosable from captured state.
## Requirements
