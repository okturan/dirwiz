# live-tree-refresh Specification

## Purpose
Keep a displayed scan current through supervised, debounced filesystem monitoring while preserving exploration state, cache continuity, and storm safety.
## Requirements
