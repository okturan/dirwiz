# website-product-presentation Specification

## Purpose
The dirwiz.app page as a verified product claim surface: feature copy, live demo parity with the shipped renderer, and download facts checked against real released assets.
## Requirements
