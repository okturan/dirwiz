# state-driven-scan-control Specification

## Purpose
The sidebar's single state-driven volume scan control: displayed-tree state, not cache files, chooses Scan Volume versus Full Rescan, and active work owns the control.
## Requirements
